...
var args28810 = [];
var len__26580__auto___28814 = arguments.length;
var i__26581__auto___28815 = (0);
while(true){
if((i__26581__auto___28815 < len__26580__auto___28814)){
args28810.push((arguments[i__26581__auto___28815]));

var G__28816 = (i__26581__auto___28815 + (1));
i__26581__auto___28815 = G__28816;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args28810.length)].join('')));
...
var G__28813 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
var G__28813__$1 = ((cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter))?cljs.core.assoc.call(null,G__28813,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint):G__28813);
return G__28813__$1;
});
...
var or__25522__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__26580__auto___28821 = arguments.length;
var i__26581__auto___28822 = (0);
while(true){
if((i__26581__auto___28822 < len__26580__auto___28821)){
args__26587__auto__.push((arguments[i__26581__auto___28822]));

var G__28823 = (i__26581__auto___28822 + (1));
i__26581__auto___28822 = G__28823;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__26588__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq28818){
var G__28819 = cljs.core.first.call(null,seq28818);
var seq28818__$1 = cljs.core.next.call(null,seq28818);
var G__28820 = cljs.core.first.call(null,seq28818__$1);
var seq28818__$2 = cljs.core.next.call(null,seq28818__$1);
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__28819,G__28820,seq28818__$2);
});
...
var line = cljs.core.get.call(null,map__28827__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__28827__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__28827,map__28827__$1,file,line,column){
return (function (p1__28824_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__28824_SHARP_));
});})(map__28827,map__28827__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__26435__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__26435__auto__,prefer_table__26436__auto__,method_cache__26437__auto__,cached_hierarchy__26438__auto__,hierarchy__26439__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__25522__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__25522__auto__)){
return or__25522__auto__;
} else {
...
var temp__4425__auto___28829 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4425__auto___28829)){
var message_28830 = temp__4425__auto___28829;
cljs.core.println.call(null,message_28830);
} else {
}
...
var temp__4425__auto___28831 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4425__auto___28831)){
var message_28832 = temp__4425__auto___28831;
cljs.core.println.call(null,message_28832);
} else {
}
...
var temp__4423__auto__ = (function (){var and__25510__auto__ = typeof exception.stack === 'string';
if(and__25510__auto__){
var G__28838 = exception.stack;
var G__28838__$1 = (((G__28838 == null))?null:clojure.string.split_lines.call(null,G__28838));
var G__28838__$2 = (((G__28838__$1 == null))?null:cljs.core.get.call(null,G__28838__$1,depth));
var G__28838__$3 = (((G__28838__$2 == null))?null:clojure.string.trim.call(null,G__28838__$2));
return G__28838__$3;
} else {
...
var vec__28839 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__28839,(0),null);
var column = cljs.core.nth.call(null,vec__28839,(1),null);
var vec__28840 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__28840,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__28840,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__28840,(2),null);
...
var m__$1 = (function (){var G__28842 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__28842) {
case "fail":
...
var G__28848 = (function (){var G__28847 = cljs.core.rest.call(null,fns);
var G__28847__$1 = (cljs.core.truth_(new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,obj)))?cljs.core.concat.call(null,obj,G__28847):G__28847);
return G__28847__$1;
})();
fns = G__28848;
continue;
...
var G__28850 = fns;
var G__28850__$1 = (((G__28850 == null))?null:cljs.core.vary_meta.call(null,G__28850,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true));
return G__28850__$1;
});
...
var G__28854 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__28854) {
...
var vec__28857 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__28857,(0),null);
var types = vec__28857;
...
return cljs.core.map.call(null,(function (p__28865){
var vec__28866 = p__28865;
var ns = cljs.core.nth.call(null,vec__28866,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__28866,(1),null);
return ((function (vec__28866,ns,vars__$1){
return (function (){
...
var G__28867 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__28867) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__28867,env,once_fixtures,each_fixtures,vec__28866,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__28867,env,once_fixtures,each_fixtures,vec__28866,ns,vars__$1){
return (function (){
var seq__28868 = cljs.core.seq.call(null,vars__$1);
var chunk__28869 = null;
var count__28870 = (0);
var i__28871 = (0);
while(true){
if((i__28871 < count__28870)){
var v = cljs.core._nth.call(null,chunk__28869,i__28871);
var temp__4425__auto___28873 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4425__auto___28873)){
var t_28874 = temp__4425__auto___28873;
each_fixture_fn.call(null,((function (seq__28868,chunk__28869,count__28870,i__28871,t_28874,temp__4425__auto___28873,v,each_fixture_fn,G__28867,env,once_fixtures,each_fixtures,vec__28866,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_28874)));
});})(seq__28868,chunk__28869,count__28870,i__28871,t_28874,temp__4425__auto___28873,v,each_fixture_fn,G__28867,env,once_fixtures,each_fixtures,vec__28866,ns,vars__$1))
);
} else {
}

var G__28875 = seq__28868;
var G__28876 = chunk__28869;
var G__28877 = count__28870;
var G__28878 = (i__28871 + (1));
seq__28868 = G__28875;
chunk__28869 = G__28876;
count__28870 = G__28877;
i__28871 = G__28878;
continue;
} else {
var temp__4425__auto__ = cljs.core.seq.call(null,seq__28868);
if(temp__4425__auto__){
var seq__28868__$1 = temp__4425__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__28868__$1)){
var c__26325__auto__ = cljs.core.chunk_first.call(null,seq__28868__$1);
var G__28879 = cljs.core.chunk_rest.call(null,seq__28868__$1);
var G__28880 = c__26325__auto__;
var G__28881 = cljs.core.count.call(null,c__26325__auto__);
var G__28882 = (0);
seq__28868 = G__28879;
chunk__28869 = G__28880;
count__28870 = G__28881;
i__28871 = G__28882;
continue;
} else {
var v = cljs.core.first.call(null,seq__28868__$1);
var temp__4425__auto___28883__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4425__auto___28883__$1)){
var t_28884 = temp__4425__auto___28883__$1;
each_fixture_fn.call(null,((function (seq__28868,chunk__28869,count__28870,i__28871,t_28884,temp__4425__auto___28883__$1,v,seq__28868__$1,temp__4425__auto__,each_fixture_fn,G__28867,env,once_fixtures,each_fixtures,vec__28866,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_28884)));
});})(seq__28868,chunk__28869,count__28870,i__28871,t_28884,temp__4425__auto___28883__$1,v,seq__28868__$1,temp__4425__auto__,each_fixture_fn,G__28867,env,once_fixtures,each_fixtures,vec__28866,ns,vars__$1))
);
} else {
}

var G__28885 = cljs.core.next.call(null,seq__28868__$1);
var G__28886 = null;
var G__28887 = (0);
var G__28888 = (0);
seq__28868 = G__28885;
chunk__28869 = G__28886;
count__28870 = G__28887;
i__28871 = G__28888;
continue;
}
} else {
...
});})(each_fixture_fn,G__28867,env,once_fixtures,each_fixtures,vec__28866,ns,vars__$1))
);
});})(each_fixture_fn,G__28867,env,once_fixtures,each_fixtures,vec__28866,ns,vars__$1))
], null);
...
//# sourceMappingURL=test.js.map?rel=1451075949105