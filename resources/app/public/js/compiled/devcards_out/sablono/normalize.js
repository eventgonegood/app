...
if(((cljs.core.set_QMARK_.call(null,class$__$1)) || (cljs.core.sequential_QMARK_.call(null,class$__$1))) && (cljs.core.every_QMARK_.call(null,(function (p1__31730_SHARP_){
return ((p1__31730_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__31730_SHARP_ === 'string');
}),class$__$1))){
...
var G__31732 = attrs;
var G__31732__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(attrs))?cljs.core.update_in.call(null,G__31732,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$):G__31732);
return G__31732__$1;
});
/**
...
var len__26580__auto___31736 = arguments.length;
var i__26581__auto___31737 = (0);
while(true){
if((i__26581__auto___31737 < len__26580__auto___31736)){
args__26587__auto__.push((arguments[i__26581__auto___31737]));

var G__31738 = (i__26581__auto___31737 + (1));
i__26581__auto___31737 = G__31738;
continue;
} else {
}
break;
...
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__26588__auto__);
});
...
return cljs.core.into.call(null,cljs.core.PersistentHashSet.EMPTY,p1__31733_SHARP_);
});})(maps__$1))
...
var G__31735 = cljs.core.apply.call(null,cljs.core.merge,maps__$1);
var G__31735__$1 = ((!(cljs.core.empty_QMARK_.call(null,classes__$1)))?cljs.core.assoc.call(null,G__31735,new cljs.core.Keyword(null,"class","class",-2030961996),classes__$1):G__31735);
return G__31735__$1;
});

sablono.normalize.merge_with_class.cljs$lang$maxFixedArity = (0);

sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq31734){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq31734));
});
/**
...
var vec__31742 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__31742,(0),null);
var names = cljs.core.nth.call(null,vec__31742,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__31742,tag_name,names){
return (function (p1__31739_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__31739_SHARP_));
});})(matches,vec__31742,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__31742,tag_name,names){
return (function (p1__31740_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__31740_SHARP_));
});})(matches,vec__31742,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__31743){
var vec__31746 = p__31743;
var tag = cljs.core.nth.call(null,vec__31746,(0),null);
var content = cljs.core.nthnext.call(null,vec__31746,(1));
...
var vec__31747 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__31747,(0),null);
var id = cljs.core.nth.call(null,vec__31747,(1),null);
var class$ = cljs.core.nth.call(null,vec__31747,(2),null);
...
//# sourceMappingURL=normalize.js.map?rel=1451075116686