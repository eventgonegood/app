...
var x__26177__auto__ = (((x == null))?null:x);
var m__26178__auto__ = (sablono.util.to_str[goog.typeOf(x__26177__auto__)]);
if(!((m__26178__auto__ == null))){
return m__26178__auto__.call(null,x);
} else {
var m__26178__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__26178__auto____$1 == null))){
return m__26178__auto____$1.call(null,x);
} else {
...
var x__26177__auto__ = (((x == null))?null:x);
var m__26178__auto__ = (sablono.util.to_uri[goog.typeOf(x__26177__auto__)]);
if(!((m__26178__auto__ == null))){
return m__26178__auto__.call(null,x);
} else {
var m__26178__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__26178__auto____$1 == null))){
return m__26178__auto____$1.call(null,x);
} else {
...
var len__26580__auto___31721 = arguments.length;
var i__26581__auto___31722 = (0);
while(true){
if((i__26581__auto___31722 < len__26580__auto___31721)){
args__26587__auto__.push((arguments[i__26581__auto___31722]));

var G__31723 = (i__26581__auto___31722 + (1));
i__26581__auto___31722 = G__31723;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__26588__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq31720){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq31720));
});
/**
...
var vec__31725 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__31725,(0),null);
var words = cljs.core.nthnext.call(null,vec__31725,(1));
...
var G__31727 = clojure.set.rename_keys.call(null,m,kmap);
var G__31727__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__31727,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys):G__31727);
return G__31727__$1;
} else {
return m;
}
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__25522__auto__ = x__$1.hasDomain();
...
//# sourceMappingURL=util.js.map?rel=1451075116632