...
var x__16232__auto__ = (((x == null))?null:x);
var m__16233__auto__ = (sablono.util.to_str[goog.typeOf(x__16232__auto__)]);
if(!((m__16233__auto__ == null))){
return m__16233__auto__.call(null,x);
} else {
var m__16233__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__16233__auto____$1 == null))){
return m__16233__auto____$1.call(null,x);
} else {
...
var x__16232__auto__ = (((x == null))?null:x);
var m__16233__auto__ = (sablono.util.to_uri[goog.typeOf(x__16232__auto__)]);
if(!((m__16233__auto__ == null))){
return m__16233__auto__.call(null,x);
} else {
var m__16233__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__16233__auto____$1 == null))){
return m__16233__auto____$1.call(null,x);
} else {
...
var len__16635__auto___18503 = arguments.length;
var i__16636__auto___18504 = (0);
while(true){
if((i__16636__auto___18504 < len__16635__auto___18503)){
args__16642__auto__.push((arguments[i__16636__auto___18504]));

var G__18505 = (i__16636__auto___18504 + (1));
i__16636__auto___18504 = G__18505;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__16643__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq18502){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq18502));
});
/**
...
var vec__18507 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__18507,(0),null);
var words = cljs.core.nthnext.call(null,vec__18507,(1));
...
var G__18509 = clojure.set.rename_keys.call(null,m,kmap);
var G__18509__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__18509,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys):G__18509);
return G__18509__$1;
} else {
return m;
}
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__15577__auto__ = x__$1.hasDomain();
